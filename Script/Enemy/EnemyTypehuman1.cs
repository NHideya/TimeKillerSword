...
public class EnemyTypehuman1 : Enemy
{
    ...
    public override void LookingDirection()
    {
        if (!eState.EncounterPlayer)
        {
            ...
            {
                transform.localScale = new Vector3(-0.007f, transform.localScale.y, transform.localScale.z);
    ...
    IEnumerator Attack1()
    {
        ...
        StartCoroutine(SetVFX(slash, effectposition, -1, new Vector3(0, 0.2f, 0), new Vector3(170, 0, 0), new Vector3(-2.4f, 2, 2)));
    ...
    IEnumerator Attack2()
    {
        ...
        audioSource.pitch =1f;
        audioSource.PlayOneShot(attackSound);
        StartCoroutine(SetVFX(slash, effectposition, -1, new Vector3(0, 0.14f, 0), new Vector3(155, 0, 0), new Vector3(-2.4f, 2, 2)));
        Hit(attackposition1, AttackArea1, new Vector2(1, 0), 20, 10, true);
        yield return new WaitForSeconds(0.333f);
        audioSource.pitch =0.8f;
        audioSource.PlayOneShot(attackSound);
        rb.velocity = new Vector2(eState.lookingRight ? 45 : -45, rb.velocity.y);
        StartCoroutine(SetVFX(slash, effectposition, 500, new Vector3(0, 0.42f, 0), new Vector3(-30, 0, 0), new Vector3(-2.4f, 2, 2)));
        Hit(attackposition1, AttackArea1, new Vector2(1, 0), 30, 10, true);
        yield return new WaitForSeconds(0.5f);
